...
export default function Signup({ 
  ...
  const lightAccent = isDarkMode ? 'rgba(78, 216, 190, 0.15)' : 'rgba(13, 147, 115, 0.15)';
    ...
    >
      ...
      <Box 
        sx={{
          ...
          backgroundImage: `radial-gradient(circle at 25px 25px, ${isDarkMode ? '#fff' : '#000'} 2%, transparent 0%)`,
      ...
      <Box
        sx={{
          ...
          height: '300px',
          borderRadius: '50%',
          background: `radial-gradient(circle, ${isDarkMode ? 'rgba(78, 216, 190, 0.1)' : 'rgba(13, 147, 115, 0.1)'} 0%, ${isDarkMode ? 'rgba(78, 216, 190, 0)' : 'rgba(13, 147, 115, 0)'} 70%)`,
      ...
      <Box
        sx={{
          ...
          height: '250px',
          borderRadius: '50%',
          background: `radial-gradient(circle, ${isDarkMode ? 'rgba(78, 216, 190, 0.08)' : 'rgba(13, 147, 115, 0.08)'} 0%, ${isDarkMode ? 'rgba(78, 216, 190, 0)' : 'rgba(13, 147, 115, 0)'} 70%)`,
        ...
        >
          ...
          >
            {success ? (
              ...
              >
                <Typography variant="h6" mb={1} fontWeight={600}>Thank you for signing up!</Typography>
                <Typography>We're excited to have you on board. We'll be in touch soon with next steps.</Typography>
              </Alert>
            ) : (
              <form onSubmit={handleSubmit}>
                <Stack spacing={4}>
                  <Box sx={{ mb: 1 }}>
                    ...
                    >
                      Name <Box component="span" sx={{ color: accentColor }}>*</Box>
                    </Typography>
                    <TextField
                      id="name"
                      fullWidth
                  ...
                  <Box>
                    ...
                    >
                      Email <Box component="span" sx={{ color: accentColor }}>*</Box>
                    </Typography>
                    <TextField
                      id="email"
                      fullWidth
          ...
          >
            By joining our Beta, you'll be first to experience our platform and have direct influence on future features. We respect your privacy and will never share your information.
          </Typography>
        </Box>
      </Container>
    </Box>
